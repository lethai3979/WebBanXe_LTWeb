...
namespace LTWeb_CodeFirst.Controllers
{
    ...
    public class PromotionController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DiscountValue,Id,IsDeleted")] Promotion promotion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DiscountValue,Id,IsDeleted")] Promotion promotion)
        {
            if (id != promotion.Id)
            {
                return NotFound();
